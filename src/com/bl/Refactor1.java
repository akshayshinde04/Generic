...
public class Refactor1 <T extends Comparable<T>> {
		...
		public static void main(String[] args) {
			System.out.println("Maximum  Number using Integer type are: " + findMaximumNumber(25, 75, 53));
			System.out.println("Maximum  Number using Double type are: " + findMaximumNumber(23.32, 89.67, 45.27));
